...
You can access the snippets by clicking **Snippets** in the [Sidebar](/en/how-to-guides/find-your-way-around/). Clicking **Snippets** takes you to the [Snippets interface](/en/concepts/wagtail-interfaces/).
...
Warning: Editing a snippet changes it on all of the pages on which it appears. In the top-right corner of the Snippet [edit screen](/en/concepts/wagtail-interfaces/), you can see a label saying how many times you have used the snippet. Clicking this label displays a listing of all of these pages.
