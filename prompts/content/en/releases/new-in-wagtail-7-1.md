...
[Image listings](/en/how-to-guides/manage-images/) now offer both grid and list layouts. The new list layout provides additional details including file names, collections, creation dates, and usage count (with support for ordering by count), allowing easier management of images.

[Document listings](/en/how-to-guides/manage-documents/) now also display usage counts, helping you quickly identify how documents are used throughout your site.
